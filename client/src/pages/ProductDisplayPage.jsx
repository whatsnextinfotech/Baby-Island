...
import { getReviews, addReview } from '../store/customerReviewSlice' // Import the review actions
...
const ProductDisplayPage = () => {
  ...
  // Get current user from your auth store (adjust as needed)
  ...
  // Fetch product details and reviews when productId changes
  useEffect(() => {
    fetchProductDetails()
    if (productId) {
  ...
  // Product Link: ${window.location.href}`;
    ...
    const whatsappNumber = "917991712623"; // Replace with your actual WhatsApp number
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            ...
            <div className="mb-3 mt-4">
              ...
              {data.colors?.map((color, index) => (
                ...
                >
                  <span className="hidden gap-20">{color}</span>
                </button>
              ))}
            </div>
                  ...
                  <div>
                    ...
                    {showReviewForm && (
                      <form onSubmit={handleSubmitReview} className="mb-6 p-4 border rounded-lg">
                          ...
                          <div className="flex gap-2 mb-2">
                            {[5, 4, 3, 2, 1].map(rating => (
                              <button
                                type="button"
                                key={rating}
                                onClick={() => setReviewForm({...reviewForm, reviewValue: rating})}
                        ...
                        <div className="mb-4">
                          <label htmlFor="reviewMessage" className="block text-sm font-medium mb-1">Your Review</label>
                          <textarea
                            id="reviewMessage"
                            name="reviewMessage"
