      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <section className="mb-16">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="h-px bg-black w-5 lg:w-12"></div>
            <h2 className="text-xl lg:text-2xl font-bold mx-4  text-black">Why Choose Baby Island</h2>
            <div className="h-px bg-black w-5 lg:w-12"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-blue-50 p-6 rounded-xl shadow-sm text-center transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
              <div className="bg-blue-100 w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-4 border border-blue-200">
            ...
            <div className="bg-blue-50 p-6 rounded-xl shadow-sm text-center transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
              ...
              <h3 className="font-bold text-lg mb-2 text-black">Easy Shopping</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-blue-50 p-6 rounded-xl shadow-sm text-center transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
              ...
              <h3 className="font-bold text-lg mb-2 text-black">Special Offers</h3>
              <p className="text-gray-600">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 bg-blue-50 p-6 rounded-xl shadow-md">
            <img
              src={Chooseus}
              alt="Happy Baby"
            ...
            <div className="w-full md:w-2/3">
              ...
              <button
                className="mt-4 bg-pink-500 text-white px-6 py-2 rounded-full font-medium hover:shadow-lg transition-all duration-300"
        ...
        <section className="mb-16">
          <div className="flex items-center justify-center mb-8">
            ...
            <h2 className=" text-xl lg:text-2xl font-bold mx-4 text-black">What Parents Say</h2>
            <div className="h-px bg-black w-12"></div>
          </div>
          ...
          <Slider {...settings} className="testimonial-slider">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="px-3">
                <div className="bg-pink-50 border border-pink-100 p-6 rounded-xl shadow-sm h-64 flex flex-col justify-between transition-all duration-300 hover:shadow-md">
                  <div>
                    <div className="flex text-yellow-400 mb-3">
                      <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                    </div>
                    <h3 className="font-bold text-lg mb-2 text-black">{testimonial.title}</h3>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8 p-6 rounded-xl shadow-md bg-blue-50">
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                <div className="bg-gray-300 px-4 py-2 rounded-full text-black font-medium">Safety First</div>
                <div className="bg-gray-300 px-4 py-2 rounded-full text-black font-medium">Quality Assured</div>
                <div className="bg-gray-300 px-4 py-2 rounded-full text-black font-medium">Eco-Friendly</div>
                <div className="bg-gray-300 px-4 py-2 rounded-full text-black font-medium">Parent Approved</div>
              </div>
            </div>
          </div>
        </section>
