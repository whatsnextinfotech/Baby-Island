...
const UploadProduct = () => {
  ...
  const handleAddCustomerreview = (event) => {
    if (event.key === 'Enter' && colorInput.trim()) {
      event.preventDefault(); // Prevent form submission
      setData({ ...data, customerreview: [...data.customerreview, customerreviewInput.trim()] });
      setCustomerreviewInput(''); // Clear input field
    }
  };
  ...
  // useEffect(()=>{
  //   successAlert("Upload succesxsfully")
  // },[])
  return (
    <section className=''>
        ...
        <div className='grid p-3'>
            <form className='grid gap-4' onSubmit={handleSubmit}>
                ...
                <div className="grid gap-1">
        <label htmlFor="customerreview" className="font-medium">customerreview</label>
        <input 
          id="customerreview"
          type="text"
          placeholder="Enter product colors "
          name="customerreview"
          value={customerreviewInput} // Bind to state
          onChange={(e) => setCustomerreviewInput(e.target.value)}
          onKeyDown={handleAddCustomerreview} // Add color on Enter key
          className="bg-blue-50 p-2 outline-none border focus-within:border-primary-200 rounded"
        />
      </div>
        ...
        <input 
          ...
          placeholder="Enter product colors "
          name="colors"
          value={colorInput} // Bind to state
          onChange={(e) => setColorInput(e.target.value)}
          onKeyDown={handleAddColor} // Add color on Enter key
          className="bg-blue-50 p-2 outline-none border focus-within:border-primary-200 rounded"
        />
      </div> */}
      ...
      {/* <div className="flex gap-2 flex-wrap">
        {data.colors.map((color, index) => (
          <span key={index} style={{ backgroundColor: color, color: '#fff', padding: '5px 10px', borderRadius: '5px' }}>
            {color}
          </span>
        ))}
      </div>
      ...
      <div className="grid gap-1">
        ...
        <input 
          ...
          name="size"
          value={sizeInput} // Bind to state
          onChange={(e) => setSizeInput(e.target.value)}
          onKeyDown={handleAddSize} // Add color on Enter key
          className="bg-blue-50 p-2 outline-none border  focus-within:border-primary-200 rounded"
        />
      </div> */}
      ...
      {/* <div className="flex gap-2 flex-wrap uppercase">
        {data.size.map((size, index) => (
          <span key={index} style={{  color: '#000', padding: '5px 10px', borderRadius: '5px', border :'1px solid black' }}>
            {size}
          </span>
        ))}
      </div> */}
