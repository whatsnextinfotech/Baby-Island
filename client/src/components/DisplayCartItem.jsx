...
import AddToCartButton from './AddToCartButton2'
        ...
        <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
            ...
            <div className='min-h-[75vh] lg:min-h-[80vh] h-full max-h-[calc(100vh-150px)] bg-blue-50 p-2 flex flex-col gap-4'>
                {/***display items */}
                {
                    cartItem[0] ? (
                        <>
                            <div className='flex items-center justify-between px-4 py-2 bg-gray-500 text-white rounded-full'>
                                                ...
                                                return(
                                                    <div key={item?._id+"cartItemDisplay"} className='flex  w-full gap-4'>
                                                        ...
                                                        <div className='w-full max-w-sm text-xs'>
                                                            ...
                                                            <p className='text-xs text-ellipsis line-clamp-2'>{item?.productId?.stock}</p>
                        ...
                        <div className='bg-white flex flex-col justify-center items-center'>
                            ...
                            />
                            <Link onClick={close} to={"/"} className='block bg-black px-4 py-2 text-white rounded'>Shop Now</Link>
                        </div>
                    )
                }
